...
(function ($) {
  ...
  $container.append(
    '<h5>Others Menu</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<button class="btn-primary col-4"><a href="/site/login"> Login </a></button> ')
  $container.append('<button class = "btn-danger col-4"><a href="/site/logout"> Logout  </a> </button')
